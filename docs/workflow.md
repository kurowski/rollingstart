...
| [`docs/plans/`](plans/) | One plan per checkpoint (P1a, P1b, …): its sub-scopes are the tracker, marked `[PENDING]` → `[COMPLETE]` as they merge, and it ends with a retrospective |
